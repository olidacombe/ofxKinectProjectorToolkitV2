...
ofxKinectProjectorToolkitV2::ofxKinectProjectorToolkitV2() {
    calibrated = false;
}

void ofxKinectProjectorToolkitV2::calibrate(vector<ofVec3f> pairsKinect,
...
ofVec2f ofxKinectProjectorToolkitV2::getProjectedPoint(ofVec3f worldPoint) {
...
vector<double> ofxKinectProjectorToolkitV2::getCalibration()
{
...
void ofxKinectProjectorToolkitV2::loadCalibration(string path){
    ofxXmlPoco xml;
    xml.load(path);
...
void ofxKinectProjectorToolkitV2::saveCalibration(string path){
    ofxXmlPoco xml;
